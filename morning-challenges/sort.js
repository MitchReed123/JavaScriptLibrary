// challenge: using Array.sort(), sort the presidents by birth year, oldest to youngest. You will ned implement logic that checks the year each president was born
const presidents = [
